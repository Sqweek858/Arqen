...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\Build\DX12\build_m29a_dx12_rotation3d_fake_light_scene.ps1")
...
$wrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m29a_dx12_rotation3d_fake_light_scene.ps1"
