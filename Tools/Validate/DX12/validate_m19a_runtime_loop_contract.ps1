...
$runtimeContract = Join-Path $root "Docs\Reference\Runtime\RUNTIME_CONTRACT.md"
$dx12Contract = Join-Path $root "Docs\Reference\Backends\DX12_BACKEND_CONTRACT.md"
$handoffDoc = Join-Path $root "Docs\Milestones\\M16_M20.md"
$capPath = Join-Path $root "Docs\Reference\Backends\WindowsX64PE_Config\capabilities_v0.txt"
$runnerPath = Join-Path $root "Tools\Internal\Test\run_test_slice.ps1"
