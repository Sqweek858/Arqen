...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\Build\DX12\build_m27c_dx12_perspective_depth_scene.ps1")
...
$wrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m27c_dx12_perspective_depth_scene.ps1"
