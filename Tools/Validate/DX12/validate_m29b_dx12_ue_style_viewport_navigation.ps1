...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\Build\DX12\build_m29b_dx12_ue_style_viewport_navigation_scene.ps1")
...
$wrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m29b_dx12_ue_style_viewport_navigation_scene.ps1"
