...
$m21dWrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m21d_dx12_triangle_smoke.ps1"
$m21fWrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m21f_dx12_triangle_loop_smoke.ps1"
