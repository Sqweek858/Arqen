...
$toolPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m20i_dx12_frame_clear_smoke.ps1"
...
$docPath = Join-Path $RepoRoot "Docs\Milestones\\M16_M20.md"
$runtimeReadmePath = Join-Path $RepoRoot "Docs\Reference\Backends\DX12_RUNTIME.md"
