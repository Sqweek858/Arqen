...
$docs = Read-All (Join-Path $RepoRoot "Docs\Milestones\\M21_M25.md")
$handoff = Read-All (Join-Path $RepoRoot "Docs\Milestones\\M21_M25.md")
...
$wrapper = Join-Path $RepoRoot "Tools\Build\DX12\build_m26c_dx12_interactive_camera_scene.ps1"
