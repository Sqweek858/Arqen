...
$wrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m21i_dx12_color_animation_smoke_polish.ps1"
$m21hWrapperPath = Join-Path $RepoRoot "Tools\Build\DX12\build_m21h_dx12_animated_triangle_smoke.ps1"
