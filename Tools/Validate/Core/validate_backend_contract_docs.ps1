...
$backendDocPath = Join-Path $root "Docs\Reference\Backends\BACKEND_CONTRACT.md"
$irDocPath = Join-Path $root "Docs\Reference\IR\ARQIR_V0_CONTRACT.md"
$dx12DocPath = Join-Path $root "Docs\Reference\Backends\DX12_BACKEND_CONTRACT.md"
$runtimeDocPath = Join-Path $root "Docs\Reference\Runtime\RUNTIME_CONTRACT.md"
