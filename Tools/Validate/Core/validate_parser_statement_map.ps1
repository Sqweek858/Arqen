...
$generatorPath = Join-Path $RepoRoot "Tools/Generate/generate_parser_statement_map.ps1"
...
foreach ($row in $rows) {
    ...
    $specPath = Join-Path $RepoRoot "Tests/CommandTests/misc/$commandId.command.txt"
