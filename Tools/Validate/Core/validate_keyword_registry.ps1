...
$keywordTool = Join-Path $RepoRoot "Tools/Generate/generate_keyword_registry.ps1"
...
$reservedDocs = @(
    (Join-Path $RepoRoot "Docs/Reference/Backends/DX12_BACKEND_CONTRACT.md"),
    (Join-Path $RepoRoot "Docs/Reference/Runtime/RUNTIME_CONTRACT.md"),
    (Join-Path $RepoRoot "Docs/Milestones/M16_M20.md")
)
