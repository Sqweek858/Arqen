...
$preferred = @("program", "end", "let", "define", "const", "called", "be", "rename", "title", "set", "to", "message", "text", "show", "print", "string", "int", "float", "double", "bool", "var", "command", "arg", "count", "write", "file", "with", "style", "for", "when", "shape", "button", "slider", "input", "field", "checkbox", "dropdown", "content", "range", "value", "placeholder", "type", "display", "color", "opacity", "visibility", "clip", "children", "font", "weight", "size", "px", "ms", "sec", "background", "foreground", "accent", "border", "outline", "corner", "radius", "padding", "margin", "align", "vertical", "line", "height", "letter", "spacing", "wrap", "shadow", "blur", "spread", "offset", "cursor", "transition", "duration", "easing", "mode", "z", "index", "hovered", "pressed", "disabled", "focused", "unfocused", "active", "selected", "checked", "loading", "load", "add", "remove", "from", "multiply", "by", "divide", "while", "function", "call", "exit", "blend", "mix", "code", "if", "else", "is", "not", "and", "or", "true", "false")
$ordered = @()
