...
$preferred = @("program", "comments", "let", "define", "rename", "title", "set_title_to", "message_text", "show_message", "show_string", "show_value", "exit", "BlendMixToCode", "literals", "plus_expression")
