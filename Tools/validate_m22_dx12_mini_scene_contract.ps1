...
$docsPath = Join-Path $RepoRoot "Docs\M22_DX12_MINI_SCENE.md"
$handoffPath = Join-Path $RepoRoot "Docs\M22_HANDOFF.md"
...
$generatorPath = Join-Path $RepoRoot "Tools\new_m22b_dx12_crystal_cluster_sample.ps1"
$wrapperPath = Join-Path $RepoRoot "Tools\build_m22i_dx12_crystal_scene.ps1"
