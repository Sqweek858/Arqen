...
$preferred = @("program", "comments", "let", "define", "command_args", "rename", "title", "set_title_to", "set_value", "message_text", "show_message", "show_string", "show_value", "print", "file_io", "math_update", "while_compile_time", "function", "exit", "BlendMixToCode", "literals", "plus_expression", "numeric_expression", "logical_condition")
