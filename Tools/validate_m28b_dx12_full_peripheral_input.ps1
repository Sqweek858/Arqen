...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\build_m28b_dx12_full_peripheral_input_scene.ps1")
...
$docs = Read-All (Join-Path $RepoRoot "Docs\M28B_DX12_FULL_PERIPHERAL_INPUT.md")
$handoff = Read-All (Join-Path $RepoRoot "Docs\M28B_HANDOFF.md")
...
$m21fValidator = Read-All (Join-Path $RepoRoot "Tools\validate_m21f_dx12_frame_loop.ps1")
...
$wrapperPath = Join-Path $RepoRoot "Tools\build_m28b_dx12_full_peripheral_input_scene.ps1"
