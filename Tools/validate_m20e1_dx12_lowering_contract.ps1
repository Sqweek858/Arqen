...
$toolPath = Join-Path $RepoRoot "Tools\lower_m20e1_dx12_clear_from_ir.ps1"
$buildPath = Join-Path $RepoRoot "Backends\DX12\Runtime\build_m20e1_dx12_clear_from_ir.ps1"
$fixtures = Join-Path $RepoRoot "Tests\DX12Lowering\M20E1"
$m20Path = Join-Path $RepoRoot "Docs\M20_HANDOFF.md"
$miniPath = Join-Path $RepoRoot "Docs\M20_DX12_MINI_BIBLE.md"
