...
$m20DocPath = Join-Path $RepoRoot "Docs\M20_HANDOFF.md"
...
$buildPath = Join-Path $RepoRoot "Backends\DX12\Runtime\build_m20a_dx12_clear.ps1"
...
Add-Result "m20a_handoff_exists" (Test-Path $m20DocPath) "Docs/M20_HANDOFF.md present"
