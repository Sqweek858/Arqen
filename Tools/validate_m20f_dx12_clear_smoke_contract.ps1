...
$toolPath = Join-Path $RepoRoot "Tools\build_m20f_dx12_clear_smoke.ps1"
$lowererPath = Join-Path $RepoRoot "Tools\lower_m20e1_dx12_clear_from_ir.ps1"
$nativeBuilderPath = Join-Path $RepoRoot "Backends\DX12\Runtime\build_m20e1_dx12_clear_from_ir.ps1"
$m20Path = Join-Path $RepoRoot "Docs\M20_HANDOFF.md"
$miniBiblePath = Join-Path $RepoRoot "Docs\M20_DX12_MINI_BIBLE.md"
$smokeDocPath = Join-Path $RepoRoot "Docs\M20F_DX12_CLEAR_SMOKE.md"
