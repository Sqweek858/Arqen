...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\build_m29c_dx12_object_selector_rotate_scene.ps1")
$toolMap = Read-All (Join-Path $RepoRoot "Docs\TOOL_MAP.md")
$milestones = Read-All (Join-Path $RepoRoot "Docs\MILESTONES.md")
$docs = Read-All (Join-Path $RepoRoot "Docs\M29C_DX12_OBJECT_SELECTOR_ROTATE.md")
$handoff = Read-All (Join-Path $RepoRoot "Docs\M29C_HANDOFF.md")
...
$wrapperPath = Join-Path $RepoRoot "Tools\build_m29c_dx12_object_selector_rotate_scene.ps1"
