...
$m20 = Read-TextSafe (Join-Path $RepoRoot "Docs\M20_HANDOFF.md")
$mini = Read-TextSafe (Join-Path $RepoRoot "Docs\M20_DX12_MINI_BIBLE.md")
$spec = Read-TextSafe (Join-Path $RepoRoot "Specs\Commands\dx12.command.txt")
$irDoc = Read-TextSafe (Join-Path $RepoRoot "IR\ARQIR_V0_CONTRACT.md")
$runtimeDoc = Read-TextSafe (Join-Path $RepoRoot "Runtime\RUNTIME_CONTRACT.md")
$dx12Doc = Read-TextSafe (Join-Path $RepoRoot "Backends\DX12\DX12_BACKEND_CONTRACT.md")
$cap = Read-TextSafe (Join-Path $RepoRoot "Backends\WindowsX64PE\Config\capabilities_v0.txt")
