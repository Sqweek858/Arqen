...
$capabilities = Read-All (Join-Path $RepoRoot "Backends\WindowsX64PE\Config\capabilities_v0.txt")
$runtimeRegistryTool = Read-All (Join-Path $RepoRoot "Tools\generate_runtime_action_registry.ps1")
...
$wrapper = Read-All (Join-Path $RepoRoot "Tools\build_m28a_dx12_window_style_box_scene.ps1")
$validator = Read-All (Join-Path $RepoRoot "Tools\validate_m27d_m28a_dx12_window_style_box.ps1")
...
$docs = Read-All (Join-Path $RepoRoot "Docs\M27D_M28A_NATIVE_WINDOW_STYLE_BOX.md")
$handoff = Read-All (Join-Path $RepoRoot "Docs\M27D_M28A_HANDOFF.md")
...
$wrapperPath = Join-Path $RepoRoot "Tools\build_m28a_dx12_window_style_box_scene.ps1"
