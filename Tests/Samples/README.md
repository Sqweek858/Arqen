...
- `Samples/DX12/dx12_ui_overlay_controls_scene_m30a.arq` extends the M29C 3D scene with a DX12-rendered UI panel, colored bitmap text, an animation toggle, and a fake-light toggle.

- `DX12/dx12_ui_layout_bridge_scene_m30b.arq` - M30B/M30C UI overlay demo with parent-relative layout, clipping, readable text, switches/buttons, M29C selection/rotation, fake lighting, and UE-style viewport navigation.

## M31A DX12 UI controls

- `Samples/DX12/dx12_ui_controls_fancy_scene_m31a.arq` demonstrates UI event-body actions, hover/pressed/focus states, slider rendering/value update, input focus skeleton, dropdown closed-state rendering, and font/texture resource metadata markers.
